...
$TESTER_PATH -s testcase1.txt $SOCKET_PATH > client1.log 2>&1 --delay 90 &
pid1=$!

$TESTER_PATH -s testcase2.txt $SOCKET_PATH > client2.log 2>&1 --delay 100 &
pid2=$!

$TESTER_PATH -s testcase3.txt $SOCKET_PATH > client3.log 2>&1 --delay 110 &
pid3=$!

$TESTER_PATH -s testcase4.txt $SOCKET_PATH > client4.log 2>&1 --delay 120 &
pid4=$!
